...
async function seedPlatforms() {
  const platforms = [
    ...
    { slug: 'INSTAGRAM', displayName: 'Instagram',  description: 'Followers, reach va engagement', enabled: false, comingSoon: true,  sortOrder: 5 },
    { slug: 'FACEBOOK',  displayName: 'Facebook',   description: 'Page likes va engagement', enabled: false, comingSoon: true,  sortOrder: 6 },
    { slug: 'THREADS',   displayName: 'Threads',    description: 'Followers va post statistikasi', enabled: false, comingSoon: true,  sortOrder: 7 },
