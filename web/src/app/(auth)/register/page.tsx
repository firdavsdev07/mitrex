...
export default function RegisterPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      loginAndStore(res.token, res.user);
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-7 text-center">
        <h1 className="text-xl font-semibold text-zinc-100 mb-1">Hisob yaratish</h1>
        <p className="text-sm text-zinc-500">Bepul boshlang, karta kerak emas</p>
      </div>
