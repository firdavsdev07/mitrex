  ...
  if (sent) {
    return (
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-xl font-semibold text-zinc-100 mb-2">Xat yuborildi</h1>
        ...
        <p className="text-xs text-zinc-600 mb-6">
          Xat kelmasa spam papkasini tekshiring. Havola 1 soat davomida amal qiladi.
        </p>
        <Link
          href="/login"
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-7 text-center">
        <h1 className="text-xl font-semibold text-zinc-100 mb-1">Parolni tiklash</h1>
        <p className="text-sm text-zinc-500">Email manzilingizni kiriting, havola yuboramiz</p>
      </div>
