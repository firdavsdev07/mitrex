...
export default function AdminPlansPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setError('Planni saqlashda xatolik yuz berdi');
    } finally {
      setSaving(false);
    }
  }
  ...
  async function handleDelete(id: string) {
    ...
    try {
      ...
      setError("Planni o'chirishda xatolik yuz berdi");
    }
  }
  ...
  function setIntField(key: keyof Plan, raw: string, fallback: number) {
    const parsed = parseInt(raw, 10);
    setField(key, Number.isNaN(parsed) ? fallback : parsed);
  }
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-zinc-500 flex-wrap">
                      ...
                      <span>
                        {plan.maxMonthlyViews === -1
                          ? '∞'
                          : plan.maxMonthlyViews.toLocaleString()}{' '}
                        views/oy
                      </span>
                      {plan.hasAiInsights && (
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Input
                  ...
                  onChange={(e) => setIntField('sortOrder', e.target.value, 0)}
                />
              </div>
              <div className="grid grid-cols-3 gap-3">
                <Input
                  ...
                  onChange={(e) =>
                    setIntField('maxWebsites', e.target.value, 1)
                  }
                />
                <Input
                  ...
                  onChange={(e) =>
                    setIntField('maxPlatforms', e.target.value, 2)
                  }
                />
                <Input
                  label="Max views/oy"
                  ...
                  onChange={(e) =>
                    setIntField('maxMonthlyViews', e.target.value, 5000)
                  }
                />
              </div>
