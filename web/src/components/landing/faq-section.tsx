...
import { MessageCircle, CreditCard, Code2, ShieldCheck, ArrowRight } from "lucide-react";
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-sm text-zinc-500 max-w-md leading-relaxed">
            Eng ko'p so'raladigan savollarni kategoriyalar bo'yicha topishingiz mumkin.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-6">
          ...
          >
            ...
            <div className="hidden md:block mt-6 p-4 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <p className="text-xs font-medium text-zinc-300 mb-1">Javob topa olmadingizmi?</p>
        ...
        <div className="md:hidden mt-8 text-center">
          ...
          <Link href="mailto:hello@metrix.io" className="text-sm font-medium text-orange-400">
            hello@metrix.io
          </Link>
        </div>
      </div>
