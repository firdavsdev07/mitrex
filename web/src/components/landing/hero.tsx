...
import { ArrowRight, Check, Sparkles, TrendingUp, Bot, Users, Globe, Zap } from "lucide-react";
...
const platforms = [
  { Icon: YouTubeIcon, name: "YouTube", stat: "3,891", sub: "obunachi", change: "+145", points: "0,20 12,16 24,14 36,10 48,6 60,3" },
  { Icon: TelegramIcon, name: "Telegram", stat: "892", sub: "a'zo", change: "+67", points: "0,18 12,15 24,13 36,10 48,8 60,5" },
  { Icon: InstagramIcon, name: "Instagram", stat: "2,100", sub: "kuzatuvchi", change: "+203", points: "0,20 12,17 24,11 36,14 48,8 60,4" },
  { Icon: WebIcon, name: "Sayt", stat: "1,247", sub: "tashrif", change: "+312", points: "0,22 12,18 24,15 36,11 48,7 60,3" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center py-16 lg:py-24">
          ...
          <div>
            ...
            >
              ...
              minimalist dashboardda. Ertalab 1 daqiqada hamma narsa
              ko'z oldingizda. AI raqamlarni oddiy tilda tushuntiradi.
            </p>
          ...
          <div className="hidden lg:block relative">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-semibold text-zinc-100">+23% o'sish</p>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[10px] font-medium text-zinc-200">AI tahlil tayyor</p>
            ...
            <div
              ...
              style={{
                transform: "perspective(1100px) rotateX(4deg) rotateY(-7deg) rotateZ(0.5deg)",
            ...
            >
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, rgba(249,115,22,0.4) 0%, rgba(249,115,22,0.05) 40%, rgba(249,115,22,0.2) 100%)",
                  backgroundSize: "200% 200%",
              ...
              {/* Body */}
              <div className="relative bg-zinc-950/98 flex" style={{ minHeight: 300 }}>
                ...
                <div className="w-36 border-r border-zinc-800/50 p-2 shrink-0 bg-zinc-900/30">
                  <div className="flex items-center gap-1.5 px-2 py-1.5 mb-2">
                    ...
                    <span className="text-[11px] font-semibold text-zinc-300">Metrix</span>
                  </div>
                  {["Dashboard", "Saytlar", "Platformalar", "Postlar", "AI Insights", "Alertlar"].map((item, i) => (
                    <div
                      key={item}
                ...
                <div className="flex-1 p-3 min-w-0">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <p className="text-[9px] text-zinc-600 uppercase tracking-wider">Umumiy ko'rinish</p>
                      <p className="text-xs font-semibold text-zinc-200 mt-0.5">Xush kelibsiz, Firdavs</p>
                    </div>
                  ...
                  <div className="grid grid-cols-4 gap-1.5 mb-3">
                    {dashboardStats.map((s) => (
                      ...
                      >
                        <p className="text-[8px] text-zinc-600 mb-0.5 uppercase tracking-wider">{s.label}</p>
                        <p className="text-[11px] font-bold text-zinc-100 tabular-nums">{s.value}</p>
                        <p className="text-[8px] text-green-400 mt-0.5 font-medium">{s.change}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="rounded-lg border border-zinc-800/50 overflow-hidden mb-2">
                    {platforms.map((p, i) => (
                      ...
                      >
                        ...
                        <span className="text-[10px] text-zinc-400 w-14 shrink-0">{p.name}</span>
                        <span className="text-[10px] font-semibold text-zinc-200 flex-1 tabular-nums">
                          {p.stat}{" "}
                          <span className="text-zinc-600 font-normal text-[9px]">{p.sub}</span>
                        </span>
                  ...
                  <div className="flex items-center gap-2 px-2.5 py-2 rounded-lg border border-orange-500/12 bg-orange-500/5">
                    ...
                    <p className="text-[10px] text-zinc-400 leading-relaxed">
                      ...
                      Instagram kanalingiz 23% o'sdi. Rasm postlar 2x ko'proq reach oldi.
                    </p>
                  </div>
                </div>
              </div>
