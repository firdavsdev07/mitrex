...
const platforms = [
  {
    ...
    stat: '3,891',
    change: '+145',
    points: '0,20 12,16 24,13 36,9 48,5 60,2',
  },
  {
    Icon: TelegramIcon,
    name: 'Telegram',
    stat: '892',
    change: '+67',
    points: '0,18 12,15 24,12 36,9 48,7 60,4',
  },
  {
    Icon: InstagramIcon,
    name: 'Instagram',
    stat: '2,100',
    change: '+203',
    points: '0,20 12,16 24,11 36,13 48,7 60,3',
  },
  {
    Icon: WebIcon,
    name: 'Sayt',
    stat: '1,247',
    change: '+312',
    points: '0,22 12,17 24,14 36,10 48,6 60,2',
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, rgba(249,115,22,0.5), rgba(251,191,36,0.3), transparent)',
        ...
        <div className="w-40 border-r border-zinc-800/50 p-2.5 shrink-0 bg-zinc-900/20">
          ...
          <div className="absolute bottom-3 left-2.5 right-2.5">
            <div className="border-t border-zinc-800/40 pt-2">
              <p className="text-[9px] text-zinc-700 mb-1.5 px-1 uppercase tracking-wider">
                Jamoa
              </p>
              <div className="flex -space-x-1.5 px-1">
                {['F', 'A', 'S'].map((l, i) => (
                  <div
                    ...
                    style={{
                      background: ['#f97316', '#3b82f6', '#22c55e'][i] + '30',
                      color: ['#f97316', '#60a5fa', '#4ade80'][i],
                    }}
                  >
                    {l}
                  </div>
            ...
            <div className="rounded-xl border border-zinc-800/50 bg-zinc-900/40 overflow-hidden">
              ...
              {platforms.map((p, i) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-bold text-zinc-200 flex-1 tabular-nums">
                    {p.stat}
                  </span>
          ...
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl border border-orange-500/15 bg-orange-500/5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-zinc-400 leading-relaxed truncate">
                Bu hafta Instagram kanalingiz 23% o&apos;sdi. Shanba kuni eng yuqori
                ko&apos;rsatkichga erishildi. Keyingi haftaga maslahat: rasm
                formatida 3 ta post.
              </p>
            </div>
      ...
      <div className="flex items-center gap-2 mt-3 p-2.5 rounded-lg bg-zinc-800/40 border border-zinc-700/30">
        ...
        <div className="ml-auto">
          <div className="w-8 h-8 rounded-full border-2 border-orange-500/30 flex items-center justify-center">
            <div
              className="w-3 h-3 border-t-2 border-r-2 border-orange-500 rounded-sm"
      ...
      <div className="mt-3 p-2.5 rounded-lg border border-orange-500/10 bg-orange-500/5 space-y-1.5">
        <div className="flex items-start gap-1.5">
          ...
          <p className="text-[10px] text-zinc-400 leading-relaxed">
            YouTube kanalingiz bu hafta 8% o&apos;sdi. Asosiy sabab — Chorshanba kuni
            yuklangan video.
          </p>
        </div>
        <div className="h-px bg-orange-500/10" />
        <p className="text-[9px] text-orange-400/70 font-medium">
          Tavsiya: yana 1 ta qisqa video yozing
        </p>
      </div>
    ),
    color: 'hover:border-orange-500/20',
    ...
    visual: (
      <div className="mt-3 space-y-1.5">
        {[
          {
            t: 'Traffic spike!',
            d: 'Sayt trafigi 2x oshdi',
            c: 'border-green-500/20 bg-green-500/5 text-green-400',
          },
          {
            t: 'Yangi manbadan',
            d: 'Twitter orqali 45 ta tashrif',
            c: 'border-blue-500/20 bg-blue-500/5 text-blue-400',
          },
        ].map((a) => (
          <div
            key={a.t}
            className={`flex items-start gap-2 p-2 rounded-lg border ${a.c}`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 border-b md:border-b-0 md:border-r border-zinc-800">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed mb-8">
            Workspace yarating, jamoa a&apos;zolarini taklif qiling. Har bir a&apos;zoga
            alohida ruxsat darajasi bering — Owner, Admin, Editor yoki Viewer.
          </p>
            ...
            {[
              {
                ...
                text: "Umumiy dashboard — hamma bir joyda ko'radi",
              },
              {
                Icon: Lock,
                text: "Alohida ruxsatlar — kim nima ko'ra olishini belgilang",
              },
            ...
            {team.map((m) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p
                    className={`text-[10px] mt-0.5 ${m.online ? 'text-green-500' : 'text-zinc-600'}`}
                  >
                ...
                {/* Role badge */}
                <span
                  className={`shrink-0 text-[10px] font-semibold px-2 py-0.5 rounded-md border ${roleColors[m.role]}`}
                >
                  {m.role}
                </span>
              </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-sm text-zinc-500 leading-relaxed">
            ...
            sinxronlashadi. AI haftalik hisobotlar yuboradi. Jamoa bilan birga
            ishlaysiz.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
          {features.map((f, i) => (
            <div
              ...
              style={{
                animation: `fade-up 0.6s ease-out ${0.25 + i * 0.1}s both`,
              }}
            >
              {/* Hover shimmer */}
              <div className="absolute top-0 left-0 right-0 h-px rounded-t-2xl overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity">
                <div
                  className="h-full bg-gradient-to-r from-transparent via-orange-400/40 to-transparent"
